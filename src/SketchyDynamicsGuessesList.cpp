#include "SketchyDynamicsGuessesList.h"
...
namespace SketchyDynamics
{
	...
	{		
		...
		_mainMaterial = MaterialManager::getSingletonPtr()->createMaterial("SD_guesseslist", "../../../textures/GuessesList.png", false, false);
		_hoverMaterial = MaterialManager::getSingletonPtr()->createMaterial("SD_guesseslist_hover", "../../../textures/GuessesList_hover.png", false, false);

		_initialTranslation = 2.0f;
		_lastGuessPosition = _initialTranslation;

		_rectangleGuess	= new AnimatedPolygon(VV_Static, "SD_guesseslist_rectangleGuess");		
		_triangleGuess	= new AnimatedPolygon(VV_Static, "SD_guesseslist_triangleGuess");
		_circleGuess	= new AnimatedPolygon(VV_Static, "SD_guesseslist_circleGuess");
		_weldGuess		= new AnimatedPolygon(VV_Static, "SD_guesseslist_weldGuess");
		_revoluteGuess	= new AnimatedPolygon(VV_Static, "SD_guesseslist_revoluteGuess");
		_ropeGuess		= new AnimatedPolygon(VV_Static, "SD_guesseslist_ropeGuess");
		_springGuess	= new AnimatedPolygon(VV_Static, "SD_guesseslist_springGuess");
		_freeformGuess	= new AnimatedPolygon(VV_Static, "SD_guesseslist_freeformGuess");
		_cancelGuess	= new AnimatedPolygon(VV_Static, "SD_guesseslist_cancelGuess");
		...
		_rectangleGuess	->setUserType(SKETCHYDYNAMICS_POLYGON_UTYPE_GUESSESLIST);
		_triangleGuess	->setUserType(SKETCHYDYNAMICS_POLYGON_UTYPE_GUESSESLIST);
		_circleGuess	->setUserType(SKETCHYDYNAMICS_POLYGON_UTYPE_GUESSESLIST);
		_weldGuess		->setUserType(SKETCHYDYNAMICS_POLYGON_UTYPE_GUESSESLIST);
		_revoluteGuess	->setUserType(SKETCHYDYNAMICS_POLYGON_UTYPE_GUESSESLIST);
		_ropeGuess		->setUserType(SKETCHYDYNAMICS_POLYGON_UTYPE_GUESSESLIST);
		_springGuess	->setUserType(SKETCHYDYNAMICS_POLYGON_UTYPE_GUESSESLIST);
		_freeformGuess	->setUserType(SKETCHYDYNAMICS_POLYGON_UTYPE_GUESSESLIST);
		_cancelGuess	->setUserType(SKETCHYDYNAMICS_POLYGON_UTYPE_GUESSESLIST);
	...
	SketchyDynamics::GuessesListGuesses GuessesList::getGuessType( Polygon *guessPoly )
	{
