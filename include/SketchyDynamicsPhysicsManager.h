#ifndef SketchyDynamicsPhysicsBodyManager_h__
#define SketchyDynamicsPhysicsBodyManager_h__
...
namespace SketchyDynamics
{
	...
	protected:
		...
		bool _simulationPaused_sketchydynamics;		// Simulation paused by SketchyDynamics (excluding selected objects)
...
#endif // SketchyDynamicsPhysicsBodyManager_h__